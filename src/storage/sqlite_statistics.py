...
from .sqlite_statistics_schema import SQLITE_STATISTICS_SCHEMA
...
class SqliteStatisticsRepository:
    ...
    def _locked_connection(self):
        """Yield the cached connection while serializing its transaction."""
    ...
    def _ensure_db_exists(self) -> None:
        ...
        with self._get_connection() as conn:
            ...
            # Create tables
            conn.executescript(SQLITE_STATISTICS_SCHEMA)
